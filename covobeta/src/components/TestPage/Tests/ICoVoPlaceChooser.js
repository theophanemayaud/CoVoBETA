      ...
      <div style={{ width: "100%" }} className="i-covo-place-chooser">
        ...
        <div className="test-content">
          <CoVoPlaceChooser
            ...
            onCoVoPlaceChosen={({ covoLat, covoLong }, gmapsPlaceId) =>
              ...
              center={{
                lat: covoCoordToRealCoord({
                  covoLat:
                    ...
                    this.state.waypoints.arrival.covoLat / 2,
                  covoLong: 0
                }).lat,
                lng: covoCoordToRealCoord({
                  ...
                  covoLong:
                    ...
                    this.state.waypoints.arrival.covoLong / 2
                }).long
              }}
              zoom={1}
            >
              <Icon
                lat={
                  covoCoordToRealCoord({
                    covoLat: this.state.waypoints.dep.covoLat,
                    covoLong: 0
                  }).lat
                }
                lng={
                  covoCoordToRealCoord({
                    covoLat: 0,
                    covoLong: this.state.waypoints.dep.covoLong
                  }).long
                }
                text={"Kreyser Avrora"}
                strategy="ligature"
              ...
              <Icon
                lat={
                  covoCoordToRealCoord({
                    covoLat: this.state.waypoints.arrival.covoLat,
                    covoLong: 0
                  }).lat
                }
                lng={
                  covoCoordToRealCoord({
                    covoLat: 0,
                    covoLong: this.state.waypoints.arrival.covoLong
                  }).long
                }
                strategy="ligature"
                title="Arrival"
